...
exports.getChildren = getChildren = (node) ->
  ...
  else if ty.isObjectExpression(node) or ty.isObjectPattern(node)
...
# for type, parents of typeTree
#   exports['is'+type] = (node) ->
#     if not node?
#       return false
...
#     if node.type is parents
#       return true

#     if node.type in parents
#       return true
